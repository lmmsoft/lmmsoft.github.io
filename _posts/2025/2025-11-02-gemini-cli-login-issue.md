...
![Google 登录成功回调页面示意（请替换为原始截图）](/images/2025/2025-11-02-gemini-cli-login-issue/gemini-cli-auth-success.png)
...
![Gemini CLI 登录 403 报错示意（请替换为原始截图）](/images/2025/2025-11-02-gemini-cli-login-issue/gemini-cli-login-error.png)
...
![开启 Gemini API 后的 Google Cloud 控制台费用页示意（请替换为原始截图）](/images/2025/2025-11-02-gemini-cli-login-issue/gemini-cli-gcp-cost.png)
...
![未启用 Gemini API 的 403 截屏示意](/images/2025/2025-11-02-gemini-cli-login-issue/gemini-cli-403-json.png)
